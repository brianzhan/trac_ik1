...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'trac_ik_examples' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/brianzhan/trac_ik/install/${idir}'.  Ask the maintainer 'Patrick Beeson <pbeeson@traclabs.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/brianzhan/trac_ik/install/lib;/home/brianzhan/trac_ik/devel/lib;/opt/ros/indigo/lib)
